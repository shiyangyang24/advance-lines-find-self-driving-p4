...
images = glob.glob('camera_cal1/*.jpg')
...
def draw_lines(img, mtx, dist):
    ...
    cv2.putText(img, center_text, (10,50), font, 1,(0,255,255),2)
    cv2.putText(img, rad_text, (10,100), font, 1,(0,255,255),2)
